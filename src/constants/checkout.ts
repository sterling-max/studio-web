...
export const MAX_COMMANDER_FOUNDER_CHECKOUT_URL = `${MAX_COMMANDER_CHECKOUT_URL}?discount=${MAX_COMMANDER_FOUNDER_DISCOUNT_CODE}`;
...
export const maxCommanderCheckoutUrls = {
  ...
  standard: import.meta.env.VITE_LEMON_SQUEEZY_STANDARD_CHECKOUT_URL || MAX_COMMANDER_CHECKOUT_URL
};
